...
// Funkcja dodawania danych do tabeli Strength
...
async function insertProficiencysToSubclassData() {
  const proficiencysToSubclassData = [
    { subclass: "Wojownik",                MieczePółtoraręczne: 4, MieczeDługie: 4, MieczeKrótkie: 4, Topory: 4, MieczeOburęczne: 4, Katany: 4, SejmitarWakizashiNinjaTo: 4, Sztylety: 4, MłotyBojowe: 4, Maczugi: 4, Włócznie: 4, Halabarda: 4, CepyBojoweMorgernszterny: 4, Wiekiery: 4, Kije: 4, Kusze: 4, DługieŁuki: 4, KrótkieŁuki: 4, Strzałki: 4, Proce: 4, StylWalkiBroniąDwuręczną: 2, StylWalkiMieczemITarczą: 2, StylWalkiJednąBronią: 2, StylWalkiDwiemaBrońmi: 2, skillPoints: 6 },
    { subclass: "Berserker",               MieczePółtoraręczne: 4, MieczeDługie: 4, MieczeKrótkie: 4, Topory: 4, MieczeOburęczne: 4, Katany: 4, SejmitarWakizashiNinjaTo: 4, Sztylety: 4, MłotyBojowe: 4, Maczugi: 4, Włócznie: 4, Halabarda: 4, CepyBojoweMorgernszterny: 4, Wiekiery: 4, Kije: 4, Kusze: 1, DługieŁuki: 1, KrótkieŁuki: 1, Strzałki: 1, Proce: 1, StylWalkiBroniąDwuręczną: 2, StylWalkiMieczemITarczą: 2, StylWalkiJednąBronią: 2, StylWalkiDwiemaBrońmi: 2, skillPoints: 6 },
    { subclass: "Zabójca_Magów",           MieczePółtoraręczne: 4, MieczeDługie: 4, MieczeKrótkie: 4, Topory: 4, MieczeOburęczne: 4, Katany: 4, SejmitarWakizashiNinjaTo: 4, Sztylety: 4, MłotyBojowe: 4, Maczugi: 4, Włócznie: 4, Halabarda: 4, CepyBojoweMorgernszterny: 4, Wiekiery: 4, Kije: 4, Kusze: 4, DługieŁuki: 4, KrótkieŁuki: 4, Strzałki: 4, Proce: 4, StylWalkiBroniąDwuręczną: 2, StylWalkiMieczemITarczą: 2, StylWalkiJednąBronią: 2, StylWalkiDwiemaBrońmi: 2, skillPoints: 6 },
    { subclass: "Kensai",                  MieczePółtoraręczne: 4, MieczeDługie: 4, MieczeKrótkie: 4, Topory: 4, MieczeOburęczne: 4, Katany: 4, SejmitarWakizashiNinjaTo: 4, Sztylety: 4, MłotyBojowe: 4, Maczugi: 4, Włócznie: 4, Halabarda: 4, CepyBojoweMorgernszterny: 4, Wiekiery: 4, Kije: 4, Kusze: -1, DługieŁuki: -1, KrótkieŁuki: -1, Strzałki: -1, Proce: -1, StylWalkiBroniąDwuręczną: 2, StylWalkiMieczemITarczą: 2, StylWalkiJednąBronią: 2, StylWalkiDwiemaBrońmi: 2, skillPoints: 6 },
    ...
    { subclass: "Kawaler",            MieczePółtoraręczne: 2, MieczeDługie: 2, MieczeKrótkie: 2, Topory: 2, MieczeOburęczne: 2, Katany: 2, SejmitarWakizashiNinjaTo: 2, Sztylety: 2, MłotyBojowe: 2, Maczugi: 2, Włócznie: 2, Halabarda: 2, CepyBojoweMorgernszterny: 2, Wiekiery: 2, Kije: 2, Kusze: -1, DługieŁuki: -1, KrótkieŁuki: -1, Strzałki: -1, Proce: -1, StylWalkiBroniąDwuręczną: 2, StylWalkiMieczemITarczą: 2, StylWalkiJednąBronią: 2, StylWalkiDwiemaBrońmi: 2, skillPoints: 4 },
    ...
    { subclass: "Iluzjonista",         Sztylety: 1, Kije: 1, Proce: 1, Strzałki: 1, MieczePółtoraręczne: -1, MieczeDługie: -1, MieczeKrótkie: -1, Topory: -1, MieczeOburęczne: -1, Katany: -1, SejmitarWakizashiNinjaTo: -1, MłotyBojowe: -1, Maczugi: -1, Włócznie: -1, Halabarda: -1, CepyBojoweMorgernszterny: -1, Wiekiery: -1, Kusze: -1, DługieŁuki: -1, KrótkieŁuki: -1, StylWalkiBroniąDwuręczną: -1, StylWalkiMieczemITarczą: -1, StylWalkiJednąBronią: -1, StylWalkiDwiemaBrońmi: -1, skillPoints: 1 },
...
async function insertThievingAbilitiesToSubclassData() {
  const thievingAbilitiesToSubclassData = [
    ...
    { subclass: "Fechmistrz",              Otwieranie_Zamków: -1, Kradzież_Kieszonkowa: 52, Ciche_Poruszanie: -1, Krycie_W_Cieniu: -1, Znajdywanie_Pułapek: -1, Wykrywanie_Iluzji: -1, Rozstawianie_Pułapek: -1, skillPointsThief: 0 },
    ...
    { subclass: "Skald",                   Otwieranie_Zamków: -1, Kradzież_Kieszonkowa: 48, Ciche_Poruszanie: -1, Krycie_W_Cieniu: -1, Znajdywanie_Pułapek: -1, Wykrywanie_Iluzji: -1, Rozstawianie_Pułapek: -1, skillPointsThief: 0 },
...
async function insertWizardSpellData() {
  const wizardSpellData = [
    ...
    //Bard special abilites
    {name: "Piruet Ofensywny", school: "SPECJALNE", level: 0, descriptionFile: "Piruet Ofensywny.txt", iconFile: "SPCL521.png", hexData: "SPCL521"},
    {name: "Piruet Defensywny", school: "SPECJALNE", level: 0, descriptionFile: "Piruet Defensywny.txt", iconFile: "SPCL522.png", hexData: "SPCL522"},
  ]
...
async function insertClericSpellData() {
  const clericSpellData = [
    ...
    {name: "Magiczny Kamień", school: "Zaczarowania, Kapłana", level: 1, descriptionFile: "Magiczny Kamień.txt", iconFile: "SPPR106.png", hexData: "SPPR106"},
    ...
    {name: "Ochrona Przed Złem", school: "Odrzucanie, Kapłana", level: 1, descriptionFile: "Ochrona Przed Złem.txt", iconFile: "SPPR107.png", hexData: "SPPR107"},
    {name: "Przełamanie Strachu", school: "Odrzucanie, Kapłana", level: 1, descriptionFile: "Przełamanie Strachu.txt", iconFile: "SPPR108.png", hexData: "SPPR108"},
    {name: "Rozkaz", school: "Zaczarowania/Zauroczenia, Kapłana", level: 1, descriptionFile: "Rozkaz.txt", iconFile: "SPPR102.png", hexData: "SPPR102"},
    {name: "Sanktuarium", school: "Odrzucanie, Kapłana", level: 1, descriptionFile: "Sanktuarium.txt", iconFile: "SPPR109.png", hexData: "SPPR109"},
    ...
    {name: "Oplątanie", school: "Przemiany, Druida", level: 1, descriptionFile: "Oplątanie.txt", iconFile: "SPPR105.png", hexData: "SPPR105"},
    //level 2 spells
    {name: "Cisza, promień 5 metrów", school: "Przemiany, Kapłana", level: 2, descriptionFile: "Cisza, promień 5 metrów.txt", iconFile: "SPPR211.png", hexData: "SPPR211"},
    {name: "Korowa Skóra", school: "Przemiany", level: 2, descriptionFile: "Korowa Skóra.txt", iconFile: "SPPR202.png", hexData: "SPPR202"},
    {name: "Młot Duchowy", school: "Inwokacje, Kapłana", level: 2, descriptionFile: "Młot Duchowy.txt", iconFile: "SPPR213.png", hexData: "SPPR213"},
    ...
    {name: "Pomoc", school: "Nekromancja, Sprowadzanie, Kapłana", level: 2, descriptionFile: "Pomoc.txt", iconFile: "SPPR201.png", hexData: "SPPR201"},
    ...
    {name: "Przywołanie Boskiej Mocy", school: "Inwokacje, Kapłana", level: 2, descriptionFile: "Przywołanie Boskiej Mocy.txt", iconFile: "SPPR214.png", hexData: "SPPR214"},
    {name: "Psalm", school: "Sprowadzanie/Przywoływanie, Kapłana", level: 2, descriptionFile: "Psalm.txt", iconFile: "SPPR203.png", hexData: "SPPR203"},
    ...
    {name: "Unieruchomienie Osoby", school: "Zaczarowania/Zauroczenia, Kapłana", level: 2, descriptionFile: "Unieruchomienie Osoby.txt", iconFile: "SPPR208.png", hexData: "SPPR208"},
    ...
    {name: "Zauroczenie Osoby lub Ssaka", school: "Zaczarowania/Zauroczenia, Druida", level: 2, descriptionFile: "Zauroczenie Osoby lub Ssaka.txt", iconFile: "SPPR204.png", hexData: "SPPR204"},
    {name: "Dobre Jagody", school: "Przemiany, Wywoływanie, Druida", level: 2, descriptionFile: "Dobre Jagody.txt", iconFile: "SPPR207.png", hexData: "SPPR207"},
    //level 3 spells
    {name: "Animacja Martwego", school: "Nekromancja, Kapłana", level: 3, descriptionFile: "Animacja Martwego.txt", iconFile: "SPPR301.png", hexData: "SPPR301"},
    ...
    {name: "Glif Strażnicy", school: "Odrzucanie, Wywoływanie, Kapłana", level: 3, descriptionFile: "Glif Strażnicy.txt", iconFile: "SPPR204.png", hexData: "SPPR204"},
    ...
    {name: "Przeklęta Strefa", school: "Nekromancja, Kapłana", level: 3, descriptionFile: "Przeklęta Srefa.txt", iconFile: "SPPR314.png", hexData: "SPPR314"},
    ...
    {name: "Strefa Czystergo Powietrza", school: "Odrzucanie, Kapłana", level: 3, descriptionFile: "Strefa Czystergo Powietrza.txt", iconFile: "SPPR318.png", hexData: "SPPR318"},
    ...
    {name: "Zdjęcie Klątwy", school: "Odrzucanie, Kapłana", level: 3, descriptionFile: "Zdjęcie Klątwy.txt", iconFile: "SPPR307.png", hexData: "SPPR307"},
    {name: "Zdjęcie Paraliżu", school: "Odrzucanie, Kapłana", level: 3, descriptionFile: "Zdjęcie Paraliżu.txt", iconFile: "SPPR308.png", hexData: "SPPR308"},
    {name: "Święte Uderzenie", school: "Nekromancja, Kapłana", level: 3, descriptionFile: "Święte Uderzenie.txt", iconFile: "SPPR313.png", hexData: "SPPR313"},
    {name: "Wezwanie Błyskawicy", school: "Przemiany, Druida", level: 3, descriptionFile: "Wezwanie Błyskawicy.txt", iconFile: "SPPR302.png", hexData: "SPPR302"},
    {name: "Wezwanie Owadów", school: "Sprowadzanie/Przywoływanie, Druida", level: 3, descriptionFile: "Wezwanie Owadów.txt", iconFile: "SPPR319.png", hexData: "SPPR319"},
    {name: "Unieruchomienie Zwierzęcia", school: "Zaczarowanie/Zauroczenia, Druida", level: 3, descriptionFile: "Unieruchomienie Zwierzęcia.txt", iconFile: "SPPR305.png", hexData: "SPPR305"},
    //level 4 spells
    {name: "Dalekowzroczność", school: "Poznanie", level: 4, descriptionFile: "Dalekowzroczność.txt", iconFile: "SPPR415.png", hexData: "SPPR415"},
    {name: "Dominacja Umysłowa", school: "Zaczarowania/Zauroczenia, Kapłana", level: 4, descriptionFile: "Dominacja Umysłowa.txt", iconFile: "SPPR405.png", hexData: "SPPR405"},
    ...
    {name: "Ochrona Przed Złem, promień 3 metry", school: "Odrzucanie, Kapłana", level: 4, descriptionFile: "Ochrona Przed Złem, promień 3 metry.txt", iconFile: "SPPR408.png", hexData: "SPPR408"},
    ...
    {name: "Pomniejsze Przywrócenie", school: "Nekromancja, Kapłana", level: 4, descriptionFile: "Pomniejsze Przywrócenie.txt", iconFile: "SPPR417.png", hexData: "SPPR417"},
    ...
    {name: "Swoboda Działania", school: "Odrzucanie, Kapłana", level: 4, descriptionFile: "Swoboda Działania.txt", iconFile: "SPPR403.png", hexData: "SPPR403"},
    ...
    {name: "Święta Moc", school: "Wywoływanie, Kapłana", level: 4, descriptionFile: "Święta Moc.txt", iconFile: "SPPR412.png", hexData: "SPPR412"},
    {name: "Wezwanie Leśnych Istot", school: "Sprowadzanie/Przywoływanie, Druida", level: 4, descriptionFile: "Wezwanie Leśnych Istot.txt", iconFile: "SPPR410.png", hexData: "SPPR410"},
    //special skills for cleric/druid subclasses
    ...
    {name: "Bitewny Chaos", school: "SPECJALNE", level: 1, descriptionFile: "Bitewny Chaos.txt", iconFile: " .png", hexData: "OHTMPS2"},
    {name: "Święta Moc", school: "SPECJALNE", level: 1, descriptionFile: "Święta Moc.txt", iconFile: "OHTMPS21.png", hexData: "OHTMPS21"},
    {name: "Zmiana Kształtu: Niedźwiedź Brunatny", school: "SPECJALNE", level: 1, descriptionFile: "Zmiana Kształtu: Niedźwiedź Brunatny.txt", iconFile: "SPCL611.png", hexData: "SPCL611"},
    {name: "Zmiana Kształtu: Niedźwiedź Czarny", school: "SPECJALNE", level: 1, descriptionFile: "Zmiana Kształtu: Niedźwiedź Czarny.txt", iconFile: "SPCL613.png", hexData: "SPCL613"},
    {name: "Zmiana Kształtu: Wilk", school: "SPECJALNE", level: 1, descriptionFile: "Zmiana Kształtu: Wilk.txt", iconFile: "SPCL612.png", hexData: "SPCL612"},
    {name: "Zmiana Kształtu: Mała Wiwerna", school: "SPECJALNE", level: 1, descriptionFile: "Zmiana Kształtu: Mała Wiwerna.txt", iconFile: "SPCL633.png", hexData: "SPCL633"},
    {name: "Zmiana Kształtu: Ognista Salamandra", school: "SPECJALNE", level: 1, descriptionFile: "Zmiana Kształtu: Ognista Salamandra.txt", iconFile: "SPCL634.png", hexData: "SPCL634"},
    {name: "Zmiana Kształtu: Pająk Mieczowiec", school: "SPECJALNE", level: 1, descriptionFile: "Zmiana Kształtu: Pająk Mieczowiec.txt", iconFile: "SPCL632.png", hexData: "SPCL632"},
    {name: "Zmiana Kształtu: Wilkołak", school: "SPECJALNE", level: 1, descriptionFile: "Zmiana Kształtu: Wilkołak.txt", iconFile: "SPCL643.png", hexData: "SPCL643"},
    //special skills for shaman
    {name: "Osłona przed duchami", school: "SPECJALNE SZAMAN", level: 1, descriptionFile: "Osłona przed duchami.txt", iconFile: "SPPR150.png", hexData: "SPPR150"},
    {name: "Skłębiona mgła", school: "SPECJALNE SZAMAN", level: 2, descriptionFile: "Skłębiona mgła.txt", iconFile: "SPPR250.png", hexData: "SPPR250"},
    {name: "Duchowa jasność umysłu", school: "SPECJALNE SZAMAN", level: 3, descriptionFile: "Duchowa jasność umysłu.txt", iconFile: "SPPR350.png", hexData: "SPPR350"},
